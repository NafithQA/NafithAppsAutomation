...
public class EmailSender {
    ...
    public void sendReportByMail() {
        ...
        String receiver3 = "haljassem@nafith.com";
        ...
        try {
            ...
            message.addRecipient(Message.RecipientType.CC, new InternetAddress(receiver3));


            // Set Subject: header field
            message.setSubject("Test Automation Report Nstar App");
